        ...
        for delta in [0.25]: 
            ...
            for eta, alpha, classifier_free_guidance_weight in best_tf8_hyper: 
                ...
                for seed in seed_list:      
                    ...
                    cmd = f"grep -Rlw './results/tune_21/TFBind10-Exact-v0/fit_samples_frac2/sampling_lr{sampling_lr}/initial_lengthscale{lengthscale}/delta{delta}/seed{seed}' -e 'train: true'"
