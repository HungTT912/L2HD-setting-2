...
# python3 train_for_all_2.py --config configs/tune_23/Template-BBDM-tfbind8-s9000-l6.0-lr0.05-d0.25.yaml --save_top \
# &python3 train_for_all_2.py --config configs/tune_23/Template-BBDM-tfbind8-s10000-l6.0-lr0.05-d0.25.yaml --save_top 
