...
def main():
    ...
    seed_list = range(2)
    file_path = './tuning_results/tune_18/result/tuning_result_tfbind8.csv'
    alpha = 1.0 
    if not os.path.isfile(file_path):
        with open(file_path, 'a') as file:
            header = ['eta', 'mean (100th)', 'std (100th)', 'mean (80th)', 'std (80th)', 'mean (50th)', 'std (50th)']
    ...
    for eta in [0.0, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.5, 1.0]:  
        ...
        nconfig.testing.classifier_free_guidance_weight = 0.0
        results_100th = []
        results_80th = []
        results_50th = []
        ...
        for seed in seed_list:      
            ...
            cmd = f"grep -Rlw './results/tune_18/TFBind8-Exact-v0/sampling_lr{sampling_lr}/noise{noise}/seed{seed}' -e 'train: true'"
        ...
        with open(file_path, 'a') as file:
            new_row = [eta, mean_score_100th, std_score_100th, mean_score_80th, std_score_80th, mean_score_50th, std_score_50th]
            writer = csv.writer(file)
