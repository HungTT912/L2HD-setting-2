...
def main():
    ...
    for lengthscale in [1.0]:
        for delta in [0.25]: 
            ...
            file_path = f'./tuning_results/tune_20/result/tuning_result_dkitty_lengthscale{lengthscale}_sampling_lr{sampling_lr}_delta{delta}.csv'
            ...
            for eta, alpha, classifier_free_guidance_weight in best_tf8_hyper:  
                ...
                for seed in seed_list:      
                    ...
                    cmd = f"grep -Rlw './results/tune_20/DKittyMorphology-Exact-v0/sampling_lr{sampling_lr}/initial_lengthscale{lengthscale}/delta{delta}/seed{seed}' -e 'train: true'"
