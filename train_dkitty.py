...
def main():
    ...
    file_path = './tuning_results/tune_12/result/tuning_result_dkitty.csv'
    if not os.path.isfile(file_path):
        with open(file_path, 'a') as file:
            header = ['delta', 'classifier_free_guidance_prob','alpha','classifier_free_guidance_weight', 'mean (100th)', 'std (100th)', 'mean (80th)', 'std (80th)', 'mean (50th)', 'std (50th)']
