...
def main():
    ...
    sampling_lr = 0.05
    # file_path = f'./tuning_results/tune_19/result/tuning_result_tfbind8_lengthscale{6}_lr{sampling_lr}_1.csv'
    ...
    for lengthscale in [6.0]:
        for delta in [0.05, 0.1, 0.5, 1.0]: 
            file_path = f'./tuning_results/tune_19/result/tuning_result_tfbind8_lengthscale{lengthscale}_lr{sampling_lr}_delta{delta}.csv'
                ...
                for classifier_free_guidance_weight in [-4.0, -3.5, -3, -2.5, -2, -1.5]: 
                    for alpha in [0.6, 0.65, 0.7, 0.75, 0.8, 0.85, 0.9, 0.95, 1.0, 1.05, 1.1, 1.15, 1.2, 1.5, 1.8]: 
                        ...
                        for seed in seed_list:      
                            ...
                            cmd = f"grep -Rlw './results/tune_19/sampling_lr{sampling_lr}/TFBind8-Exact-v0/initial_lengthscale{lengthscale}/delta{delta}/seed{seed}' -e 'train: true'"
