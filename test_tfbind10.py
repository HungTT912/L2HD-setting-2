...
def main():
    ...
    seed_list = range(8)
    file_path = './tuning_results/tune_11/result/tuning_result_tfbind10_eta.csv'
    ...
    for eta, alpha, classifier_free_guidance_weight in hyper_parameter_list: 
        ...
        for seed in seed_list:   
            ...
            cmd = f"grep -Rlw './results/tune_6/TFBind10-Exact-v0' -e 'noise: {noise}'  | xargs grep -lw 'classifier_free_guidance_prob: {classifier_free_guidance_prob}' | xargs grep -lw 'seed: {seed}'"
