...
def main():
    ...
    seed_list = range(1)
    file_path = './tuning_results/tune_wandb/result/tuning_result_ant.csv'
    ...
    for eta, alpha, classifier_free_guidance_weight in hyper_parameter_list: 
        ...
        for seed in seed_list:    
            cmd = f"grep -Rlw './results/tune_wandb/AntMorphology-Exact-v0/sampling_lr{sampling_lr}/noise{noise}/seed{seed}' -e 'seed: {seed}'"
        ...
        with open(file_path, 'a') as file:
            new_row = [eta,alpha, classifier_free_guidance_weight, mean_score_100th, std_score_100th, mean_score_80th, std_score_80th, mean_score_50th, std_score_50th]
            writer = csv.writer(file)
