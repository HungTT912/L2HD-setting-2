...
def main():
    ...
    seed_list = range(8)
    file_path = './tuning_results/tune_wandb/result/tuning_result_tfbind8_2.csv'
                ...
                for classifier_free_guidance_weight in [-4.0, -3.5, -3, -2.5, -2, -1.5]: 
                    for alpha in [2.0, 1.5, 1.2, 1.0, 0.9, 0.8, 0.7]: 
                        ...
                        for seed in seed_list:   
                            ...
                            cmd = f"grep -Rlw './results/tune_6/TFBind8-Exact-v0' -e 'noise: {noise}'  | xargs grep -lw 'sampling_from_GP_lr: {sampling_lr}' | xargs grep -lw 'seed: {seed}'"
