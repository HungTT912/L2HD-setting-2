...
def create_filename_and_wandb_name(type_points):
    return f"./configs/ablation_studies/{abst}_GP_type_of_initial_points/Template-BBDM-{task}-type_points_{type_points}",f"{abst}-{task}-type_points_{type_points}"

# Generate config files
for type_points in type_points_list: 
    filename, wandb_name = create_filename_and_wandb_name(type_points)
