...
def main():
    ...
    for lengthscale in [1.0]:
        for delta in [0.25]: 
            ...
            file_path = f'./tuning_results/tune_22_100steps/result/tuning_result_dkitty_lengthscale{lengthscale}_sampling_lr{sampling_lr}_delta{delta}.csv'
            ...
            for eta, alpha, classifier_free_guidance_weight in best_tf10_hyper: 
                ...
                for seed in seed_list:      
                    ...
                    cmd = f"grep -Rlw './results/tune_20/DKittyMorphology-Exact-v0/sampling_lr0.001/initial_lengthscale1.0/delta0.25' -e 'train: true'"
