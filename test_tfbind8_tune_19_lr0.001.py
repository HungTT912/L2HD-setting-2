...
def main():
    ...
    seed_list = range(8)
    file_path = './tuning_results/tune_19/result/tuning_result_tfbind8_3.csv'
        ...
        for delta in [0.25]: 
            for eta in [0.0, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.5, 1.0]:
                for classifier_free_guidance_weight in [-4.0, -3.5, -3, -2.5, -2, -1.5, 0.0, 1.0, 2.0, 3.0, 4.0, 0.5, 1.5, 2.5, 3.5, 4.5, 5.0, 5.5, 6.0]: 
                    for alpha in [0.7, 0.8, 0.9, 0.95, 1.0, 1.2, 1.5, 2., 1.6, 1.3, 1.1, 1.8]: 
                        ...
                        for seed in seed_list:      
                            ...
                            cmd = f"grep -Rlw './results/tune_19/sampling_lr0.001/TFBind8-Exact-v0/initial_lengthscale{lengthscale}/delta{delta}/seed{seed}' -e 'train: true'"
