...
def main():
    ...
    for lengthscale in [5.0]:
        for delta in [0.25]: 
            ...
            file_path = f'./tuning_results/tune_22_100steps/result/tuning_result_tfbind8_num_fit_samples{num_fit_samples}_lengthscale{lengthscale}_sampling_lr{sampling_lr}_delta{delta}.csv'
