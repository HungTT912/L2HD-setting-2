...
def main():
    ...
    seed_list = range(8)
    file_path = './tuning_results/tune_15/result/tuning_result_tfbind8.csv'
                ...
                for classifier_free_guidance_weight in [-4.0, -3.5, -3, -2.5, -2, -1.5, 0.0, 1.0, 2.0, 3.0, 4.0, 0.5, 1.5, 2.5, 3.5, 4.5, 5.0, 5.5, 6.0]: 
                    for alpha in [0.7, 0.8, 0.9, 1.0, 1.2, 1.5, 2., 1.6, 1.3, 1.1, 1.8]: 
                        ...
                        for seed in seed_list:   
                            ...
                            cmd = f"grep -Rlw './results/tune_15/TFBind8-Exact-v0/sampling_lr{sampling_lr}/noise{noise}/seed{seed}' -e 'train: true'"
