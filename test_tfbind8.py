...
def main():
    ...
    delta = 0.05 
    for sampling_lr in [0.1, 0.05, 0.01]:
        for noise in [1e-6]: 
            for eta in [0.0, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3]:
                for classifier_free_guidance_weight in [-4.0, -3.5, -3, -2.5, -2, -1.5]: 
                    for alpha in [2.0, 1.5, 1.2, 1.1, 1.05, 1.0, 0.95, 0.9, 1.15, 1.25, 1.3, 1.4, 1.45 ]: 
                        ...
                        for seed in seed_list:   
                            ...
                            cmd = f"grep -Rlw './results/tune_wandb/TFBind8-Exact-v0/sampling_lr{sampling_lr}/noise{noise}/seed{seed}' -e 'train: true'"
