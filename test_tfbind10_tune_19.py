...
def main():
    ...
    seed_list = range(8)
    file_path = './tuning_results/tune_19/result/tuning_result_tfbind10.csv'
        ...
        for delta in [0.25]: 
            for eta in [0.0, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.5, 1.0]:
                for classifier_free_guidance_weight in [-4.0, -3.5, -3, -2.5, -2, -1.5]: 
                    for alpha in [0.6, 0.65,0.7,0.75, 0.8, 0.85, 0.9, 0.95, 1.1, 1.05, 1.15, 1.0, 1.2, 1.8, 1.5]: 
                        ...
                        for seed in seed_list:      
                            ...
                            cmd = f"grep -Rlw './results/tune_19/TFBind10-Exact-v0/initial_lengthscale{lengthscale}/delta{delta}/seed{seed}' -e 'train: true'"
