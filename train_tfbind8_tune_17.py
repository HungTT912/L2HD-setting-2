...
def main():
    ...
    seed_list = range(8)
    hyperparameter_list =[[5,1],[4,0.25],[6,0.25]]
    
    
    
    file_path = './tuning_results/tune_17/result/tuning_result_tfbind8.csv'
    ...
    for lengthscale,delta in hyperparameter_list: 
        nconfig.args.train = True  
        nconfig.model.model_load_path = None 
        nconfig.model.optim_sche_load_path = None 
        nconfig.GP.initial_lengthscale = lengthscale 
        nconfig.GP.initial_outputscale = lengthscale 
        nconfig.GP.delta_lengthscale = delta
        nconfig.GP.delta_variance = delta 
