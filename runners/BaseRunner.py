    ...
    def __init__(self, config):
        ...
        if self.config.args.train:
            self.config.result.ckpt_path = make_save_dirs(self.config.args,
                                                    prefix=self.config.tune+'/'+ self.config.task.name + f'/initial_lengthscale{self.config.GP.initial_lengthscale}/delta{self.config.GP.delta_lengthscale}/seed{self.config.args.seed}',
                                                    suffix=self.config.model.model_name,
                                                    with_time=False)
            # self.config.result.ckpt_path = make_save_dirs(self.config.args,
