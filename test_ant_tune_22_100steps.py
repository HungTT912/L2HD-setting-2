...
def main():
    ...
    for lengthscale in [1.0]:
        for delta in [0.25]: 
            ...
            file_path = f'./tuning_results/tune_23/result/tuning_result_ant_lengthscale{lengthscale}_sampling_lr{sampling_lr}_delta{delta}.csv'
            ...
            for alpha in [0.9,0.95,0.85,0.8]: 
